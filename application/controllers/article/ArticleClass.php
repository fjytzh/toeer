<?php defined('SYSPATH') OR die('No direct access allowed.');
	class ArticleClass_Controller extends Template_Controller 
	{
		private $_model;
		public function __construct()
		{
			parent::__construct();
			comm::validUser();
			$this->_model	= new ArticleClass_Model;	
		}
		
		public function add()
		{
			$this->template->content	= new View('article/class/add_view');
		}	
			
		public function listForm()
		{
			$this->template->js			= array('article/class/list.js');
			$this->template->content	= new View('article/class/list_view');
		}
		...
		public function edit()
		{
			...
			$this->template->content = new View('article/class/add_view',$data);			
		}
